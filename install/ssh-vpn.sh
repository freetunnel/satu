...
curl https://raw.githubusercontent.com/freetunnel/satu/main/install/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/freetunnel/satu/main/install/vps.conf > /etc/nginx/conf.d/vps.conf
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/freetunnel/satu/install/main/squid3.conf"
