...
Isadmin=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/admin | grep $MYIP | awk '{print $5}')
if [ "$Isadmin" = "ON" ]; then
m-ipku.sh
else
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
...
listuser=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/admin | grep $MYIP | awk '{print $7}')
...
rm -rf .git &> /dev/null
git init &> /dev/null
wget https://raw.githubusercontent.com/${USERGIT}/iz/main/ip &> /dev/null

data=( `cat /root/iz/ip | grep '^###' | cut -d ' ' -f 2 | sort | uniq`);
now=`date +"%Y-%m-%d"`
for user in "${data[@]}"
do
...
git remote add origin https://github.com/${USERGIT}/iz.git &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/iz.git &> /dev/null
else
echo -e "$COLOR1╭═══════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│ ${NC}${COLBG1}            ${WH} KAMU BUKAN SUPER ADMIN              ${NC}$COLOR1 │$NC"
echo -e "$COLOR1╰═══════════════════════════════════════════════════╯${NC}"
...
function add_ip(){
clear
nama2=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $2}')
author=$(cat /etc/profil)
TIMES="10"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/${USERGIT}/iz/main/ip | awk '{print $4}' | grep $daftar)
...
MYIP=$(curl -sS ipv4.icanhazip.com)
U2=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $6}')

echo "### $client $exp $daftar" >> /etc/iz/ip
...
git branch -M main &> /dev/null
git remote add origin https://github.com/${USERGIT}/iz &> /dev/null
git push -f https://${APIGIT}@github.com/${USERGIT}/iz &> /dev/null
sleep 1
d1=$(date -d "$exp" +%s)
d2=$(date -d "$hariini" +%s)
...
<b><i>Terima Kasih Sudah Menggunakan Credits By Freetunnel</i></b>
"
...
job2=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $7}')
ip=$(curl -sS https://raw.githubusercontent.com/freetunnel/iz/main/ip | grep $MYIP | awk '{print $6}')
sisaip=$(cat /etc/iz/ip | wc -l) 
...
<i>Tunggu 5Menit Untuk Server KeRefresh</i>
<b><i>Terima Kasih Sudah Menggunakan Credits By Freetunnel</i></b>
"'&reply_markup={"inline_keyboard":[[{"text":"CHANNEL","url":"https://t.me/freetunnel 1"},{"text":"ORDER AUTOSCRIPT","url":"https://t.me/freetunnel 1"}]]}'
else
TEXT="
<code>◇━━━━━━━━━━━━━━◇</code>
<b>   Info License Key </b>
...
clear
MYIP=$(curl -sS ipv4.icanhazip.com)
listuser=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $7}')
uu=$(curl -sS https://pastebin.com/raw/BZ9Fcnqf)
...
U2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $6}')
ws=1
...
MYIP=$(curl -sS ipv4.icanhazip.com)
UU2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $2}')

U2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIPhttps://raw.githubusercontent.com/casper9/permission/main/ip | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $6}')
...
Isadmin=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $5}')
ip=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $6}')
