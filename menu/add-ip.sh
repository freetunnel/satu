...
nama2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $2}')
Exp2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $3}')
job2=$(curl -sS https://raw.githubusercontent.com/awanklod/izin_satu/main/ip | grep $MYIP | awk '{print $7}')
